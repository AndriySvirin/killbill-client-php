...
class Killbill_Client {
  ...
  public function request($method, $uri, $data = null, $user = null, $reason = null, $comment = null, $additional_headers = null, $contentType = 'application/json; charset=utf-8') {
    return $this->_sendRequest($method, $uri, $data, $user, $reason, $comment, $additional_headers, $contentType);
  }

  private function _sendRequest($method, $uri, $data = null, $user = null, $reason = null, $comment = null, $additional_headers = null, $contentType) {
